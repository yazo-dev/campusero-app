...
public class ScannerQRActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
            ...
            case REQUEST_CAMERA:
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted) {
                        ...
                        Toast.makeText(getApplicationContext(), "Permission denied, you can not access and camera", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(ScannerQRActivity.this)
                .setMessage(message)
    ...
    public void handleResult(Result result) {
        ...
        Intent i = new Intent(this, PontuacaoActivity.class);
        startActivity(i);
    }
}
